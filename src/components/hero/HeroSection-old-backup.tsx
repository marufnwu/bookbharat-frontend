              ...
              <div className="grid grid-cols-3 gap-3">
                {config.stats.slice(0, 3).map((stat, index) => (
                  <div key={index} className="text-center">
                    <p className="text-xl md:text-2xl font-light text-gray-900">{stat.value}</p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-3 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h1 className="text-xl md:text-3xl lg:text-6xl font-bold leading-tight">
      ...
      <section className={cn(
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-xl md:text-2xl lg:text-4xl font-bold text-white mb-3 leading-tight">
            ...
            {config.stats && config.stats.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-16 pt-12 border-t border-white/10">
  ...
  return (
    <section className={cn(
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {config.stats && config.stats.length > 0 && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 pt-12 border-t border-gray-200">
            {config.stats.map((stat, index) => (
              <div key={index} className="text-center group">
