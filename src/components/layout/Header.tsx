        ...
        <div className="bg-primary text-primary-foreground hidden lg:block">
          <div className="max-w-7xl mx-auto compact-container">
            <div className="flex items-center justify-between h-6 text-xs">
              ...
              {siteConfig?.payment?.free_shipping_enabled && siteConfig?.payment?.free_shipping_threshold && siteConfig.payment.free_shipping_threshold > 0 && (
                <div>
                  <span>Free shipping on orders above ₹{siteConfig.payment.free_shipping_threshold}!</span>
                </div>
              )}
            </div>
          </div>
