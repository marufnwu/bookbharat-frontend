    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-16">
        <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
          Your <span className="text-primary">Knowledge</span> Partner Since 2014
        </h1>
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
          BookBharat is India's leading online bookstore, connecting millions of readers with their next great read. 
          We believe in the power of books to transform lives and build communities.
        </p>
      ...
      <div className="grid lg:grid-cols-2 gap-12 mb-16">
        <Card className="border-l-4 border-l-primary">
          <CardContent className="p-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              To make quality books accessible to everyone, everywhere. We strive to be the bridge between 
              knowledge seekers and the vast world of literature, ensuring that great books reach every corner 
              of India and beyond.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-accent">
          <CardContent className="p-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              To create a world where every person has access to the knowledge and stories that can enrich their lives. 
              We envision BookBharat as the most trusted and beloved bookstore, fostering a culture of reading and learning.
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={index} className="text-center">
              ...
              <h4 className="font-semibold text-foreground mb-1">{recognition.award}</h4>
