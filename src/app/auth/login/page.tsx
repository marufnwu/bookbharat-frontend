...
import { Eye, EyeOff, BookOpen, Loader2, Phone, KeyRound } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const { login: passwordLogin, setUser, setToken, isLoading } = useHydratedAuth();
        ...
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center">
          <Card className="w-full max-w-md mx-4">
            <CardContent className="pt-6 pb-6 text-center space-y-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Logging you in...</h3>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-muted-foreground mt-1">
            Sign in to your BookBharat account
          </p>
        </div>
